...
Bu dosya [patika.dev](https://www.patika.dev/tr)'e ait olan [Mahir Berat Menteş ] tarafından yapılmış ["Veri Yapıları ve Algoritmalar"](https://app.patika.dev/courses/veri-yapilari-ve-algoritmalar/) dersinin  [**Inserition Sort**](https://app.patika.dev/courses/veri-yapilari-ve-algoritmalar/insertion-sort-proje) ödevini içermektedir.
